...
Расширение для работы с Cleaner и Pyrus: группировка OpenEnds, VerifyMain с поиском респондентов и ручной чисткой, виджеты на странице редактирования проекта, перенос данных проекта из Pyrus в Cleaner и фильтры списка проектов.
...
- После открытия Cleaner расширение автоматически пытается открыть форму добавления проекта и подставить поля.
